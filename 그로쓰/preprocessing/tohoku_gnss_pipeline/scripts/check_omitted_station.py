...
"""
Compare stations within Tohoku region against generated GNSS window files
...
IN_300KM_CSV = GNSS_TOHOKU_CSV / "stations_tohoku_bbox.csv"
OUT_MISSING_CSV = GNSS_TOHOKU_CSV / "missing_stations_tohoku_vs_windows.csv"
