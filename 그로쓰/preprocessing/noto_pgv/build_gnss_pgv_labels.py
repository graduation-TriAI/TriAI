import pandas as pd
from shared.paths import PAIRS_NOTO_CSV, PGV_NOTO

PAIR_CSV = PAIRS_NOTO_CSV / "station_pairs_ver_15km.csv"
PGV_CSV = PGV_NOTO / "noto_processed_pgv_data.csv"
OUT_CSV = PGV_NOTO / "noto_gnss_pgv_labels_15km.csv"
