...
MODEL_SAVE_PATH = GNSS_TOHOKU_PROC / "gnss_pgv_log_best_15km.pt"
...
class GNSSPGVDataset(Dataset):
    def __init__(self, npz_path):
        ...
        self.y = torch.log(torch.tensor(data["y"], dtype=torch.float32))    
    ...
    with torch.no_grad():
        for X, y in loader:
            ...
            if y_mean is not None and y_std is not None:
                ...
                pred_orig = torch.exp(pred_orig)
                y_orig = torch.exp(y_orig)
