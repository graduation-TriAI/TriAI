...
**지진파형–GNSS 멀티모달 딥러닝**을 통한 **PGV 추정** 및 공간 진도 시각화
...
- 대지진 3종류에 대해 **K-Fold Cross Validation**을 활용하여 **PGV 추정**
	- [모델 1] 학습: 대지진 1, 대지진 2 / 검증: 대지진 3
	- [모델 2] 학습: 대지진 2, 대지진 3 / 검증: 대지진 1
	- [모델 3] 학습: 대지진 3, 대지진 1 / 검증: 대지진 2

- 평가 방식
	- 각 모델에서 검증 데이터의 **PGV 예측 성능을 평가**
	- 3개 Fold의 결과를 종합해 **모델의 일반화 성능**을 분석
...
| 역할 | 팀장, 서류 메인 관리, 디코더 설계, 데이터 수집 및 전처리, 레이블 및 기타 데이터 처리 | 팀원, 깃허브 메인 관리, 데이터 수집 및 전처리, 연속파형 모델 설계 및 학습, 검증 | 팀원, 노션 메인 관리, 데이터 수집 및 전처리, GNSS 모델 설계 및 학습, 검증 |
